...
public class UWisePlusLayer1PruningPlus<T> extends UWisePlusLayer1Pruning<T> {
    ...
    public static int dfsOnLayer1(int[] prefix_sum, ArrayList<ArrayList<Integer>> segments, int depth, int cur, int goal) {
        int lower_bound;
    ...
    public static int processLayer1Points(HashSet<Integer> parents_set, int bound, int goal) {
